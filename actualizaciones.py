...
def aplicar_actualizaciones(html: str) -> str:
  ...
  <div class="cuerpo" style="justify-content:flex-start">
    ...
    html = re.sub(
        ...
        '</div>'
        '<div style="position:relative;display:grid;grid-template-columns:repeat(5,minmax(120px,1fr));gap:12px;margin:8px 0 14px;padding-top:5px">'
        '<div style="position:absolute;left:8%;right:8%;top:24px;height:4px;background:linear-gradient(90deg,#2a62a7 0%,#2a62a7 76%,#d8a13a 76%,#c94638 100%);border-radius:4px"></div>'
        '<div style="position:relative;text-align:center;z-index:1"><span style="display:flex;width:40px;height:40px;margin:auto;align-items:center;justify-content:center;border-radius:50%;background:#2a62a7;color:white;font-weight:800">1</span><b style="display:block;margin-top:8px">19 MAY</b><small>Hospital informa<br>3 equipos fuera de operación</small></div>'
        '<div style="position:relative;text-align:center;z-index:1"><span style="position:absolute;top:-7px;left:0;color:#315f9e;font-size:11px;font-weight:800">+57 días</span><span style="display:flex;width:40px;height:40px;margin:auto;align-items:center;justify-content:center;border-radius:50%;background:#2a62a7;color:white;font-weight:800">2</span><b style="display:block;margin-top:8px">15 JUL</b><small>CTAR N.° 149<br>aprueba EETT y bajas</small></div>'
        '<div style="position:relative;text-align:center;z-index:1"><span style="position:absolute;top:-7px;left:0;color:#315f9e;font-size:11px;font-weight:800">+6 días</span><span style="display:flex;width:40px;height:40px;margin:auto;align-items:center;justify-content:center;border-radius:50%;background:#2a62a7;color:white;font-weight:800">3</span><b style="display:block;margin-top:8px">21 JUL</b><small>IF solicita cotización<br>a la concesionaria</small></div>'
        '<div style="position:relative;text-align:center;z-index:1"><span style="position:absolute;top:-7px;left:0;color:#a66a17;font-size:11px;font-weight:800">+9 días</span><span style="display:flex;width:40px;height:40px;margin:auto;align-items:center;justify-content:center;border-radius:50%;background:#d8a13a;color:white;font-weight:800">4</span><b style="display:block;margin-top:8px">30 JUL</b><small>CTAR N.° 150<br>autoriza avanzar con CNO</small></div>'
        '<div style="position:relative;text-align:center;z-index:1"><span style="position:absolute;top:-7px;left:0;color:#c94638;font-size:11px;font-weight:800">+14 días</span><span style="display:flex;width:40px;height:40px;margin:auto;align-items:center;justify-content:center;border-radius:50%;background:#c94638;color:white;font-weight:800">!</span><b style="display:block;margin-top:8px;color:#c94638">13 AGO</b><small><b>Aún no disponibles</b><br>en el Hospital</small></div>'
        '</div>'
        '<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:10px 0 14px">'
        '<div style="border-left:5px solid #2a62a7;background:#edf4fc;padding:10px 12px;border-radius:6px"><b style="color:#2a62a7">✓ Avance administrativo</b><br>Se aprobaron antecedentes y se autorizó continuar el proceso.</div>'
        '<div style="border-left:5px solid #c94638;background:#fff1ef;padding:10px 12px;border-radius:6px"><b style="color:#c94638">⚠ Resultado pendiente</b><br>Falta una fecha comprometida de compra, entrega e instalación.</div>'
        '</div>'
        '<span style="display:inline-block;margin-bottom:12px;color:#315f9e"><b>Mensaje para MINSAL:</b> el caso demuestra que un acuerdo administrativo no equivale todavía a una solución asistencial disponible.</span><br>'
